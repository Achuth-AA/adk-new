...
import { ArrowLeft, Users, BarChart3, CheckSquare, AlertTriangle, TrendingUp, Clock, Activity, Package, GitBranch, Laptop, Eye, MessageSquare, Play, Target, Zap, Shield, FileText, Settings } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Executes test scripts with intelligent orchestration and monitoring</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  ...
                  <span className="px-2 py-1 bg-red-500/20 text-red-400 text-xs rounded">critical</span>
                  <span className="px-2 py-1 bg-green-500/20 text-green-400 text-xs rounded">Assigned</span>
                  <span className="px-2 py-1 bg-blue-500 text-white text-xs rounded">My Tasks</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Executing regression suite across multiple environments</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Analyzes test failures and provides intelligent recommendations</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-purple-500/20 text-purple-400 text-xs rounded">analysis</span>
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-xs rounded">high</span>
                  <span className="px-2 py-1 bg-green-500/20 text-green-400 text-xs rounded">Assigned</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Analyzing payment gateway security test failures</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">567</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">97.3%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Validates and prepares test environments for execution</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-green-500/20 text-green-400 text-xs rounded">integration</span>
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-400">Status:</span>
                    <span className="px-2 py-1 bg-yellow-500 text-white text-xs rounded">Waiting</span>
                  </div>
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Preparing load testing environment configuration</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">189</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">95.1%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Coordinates and manages multi-agent test workflows</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-orange-500/20 text-orange-400 text-xs rounded">orchestration</span>
                  <span className="px-2 py-1 bg-red-500/20 text-red-400 text-xs rounded">critical</span>
                  <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">Available</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Managing end-to-end test suite execution across 5 agents</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">2134</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">99.8%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Executes load, stress, and performance benchmarks</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Running stress test on checkout API with 10K concurrent users</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">856</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">98.2%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-2">
                    <div className="bg-gradient-to-r from-green-500 to-green-400 h-2 rounded-full" style={{ width: '88%' }}></div>
                  </div>
                </div>

                <div className="w-full py-2 bg-red-500/20 text-red-400 rounded-lg text-sm font-medium text-center mb-3">
                  Critical Alert - Review Now
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Performs vulnerability scans and security assessments</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-400">Status:</span>
                    <span className="px-2 py-1 bg-red-500 text-white text-xs rounded">Alert</span>
                  </div>
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Detected SQL injection vulnerability in user authentication</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">423</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">99.5%</span>
                    </div>
                  </div>
                </div>
                ...
                <button className="w-full py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-lg text-sm font-medium transition-colors mb-3">
                  Critical Alert - Review Now
                </button>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Validates REST/GraphQL endpoints and integrations</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-cyan-500/20 text-cyan-400 text-xs rounded">integration</span>
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-xs rounded">medium</span>
                  <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">Available</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Testing GraphQL mutations for user profile updates</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">678</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">96.4%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Creates comprehensive test reports and analytics</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-indigo-500/20 text-indigo-400 text-xs rounded">analysis</span>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Generating weekly test automation summary report</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">312</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Manages test data generation and cleanup</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-purple-500/20 text-purple-400 text-xs rounded">core</span>
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-xs rounded">medium</span>
                  <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">Available</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Generating synthetic data for payment module testing</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">445</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">94.2%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-2">
                    <div className="bg-gradient-to-r from-green-500 to-green-400 h-2 rounded-full" style={{ width: '79%' }}></div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Tracks test execution and system health metrics</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-teal-500/20 text-teal-400 text-xs rounded">analysis</span>
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-xs rounded">high</span>
                  <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">Available</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Monitoring test suite performance across 8 environments</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">1892</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">99.9%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Integrates with CI/CD pipelines and deployment tools</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex gap-2 mb-4">
                  <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">integration</span>
                  <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 text-xs rounded">medium</span>
                  <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded">Available</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-gray-400 mb-1">Current Task</p>
                    <p className="text-sm font-medium">Waiting for Jenkins pipeline to complete deployment</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-400">Tasks:</span>
                      <span className="ml-2 font-semibold">523</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Uptime:</span>
                      <span className="ml-2 font-semibold">92.6%</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-900 rounded-lg p-5 border border-gray-700">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-2">
                    <div className="bg-green-500 h-2 rounded-full" style={{ width: '82.8%' }}></div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-5 border border-gray-700">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-2">
                    <div className="bg-yellow-500 h-2 rounded-full" style={{ width: '79.1%' }}></div>
                  </div>
                </div>
              ...
              <div className="bg-gray-900 rounded-lg p-5 border border-gray-700">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-2">
                    <div className="bg-yellow-500 h-2 rounded-full" style={{ width: '77.6%' }}></div>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-lg p-5 border border-gray-700">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h4 className="text-lg font-medium">Review Payment Gateway Security Test Results</h4>
                      <span className="px-2 py-1 text-xs rounded-full bg-red-500 text-white">critical</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-red-500 text-white">needs approval</span>
                    </div>
                    <p className="text-gray-400 text-sm mb-4">Critical security vulnerabilities detected in payment flow - requires immediate review and sign-off</p>
                    
                    <div className="grid grid-cols-4 gap-6 text-sm">
                      <div>
                        <p className="text-gray-500">Agent:</p>
                        <p className="text-gray-300">Test Failure Analysis Agent</p>
                      </div>
                      <div>
              ...
              <div className="bg-red-900/20 rounded-lg p-5 border border-red-700">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h4 className="text-lg font-medium">Configure Load Testing Environment</h4>
                      <span className="px-2 py-1 text-xs rounded-full bg-gray-700 text-white">high</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-red-600 text-white">blocked</span>
                    </div>
                    <p className="text-gray-400 text-sm mb-4">Setup and configuration of load testing environment - blocked by security review completion</p>
                    
                    <div className="grid grid-cols-3 gap-6 text-sm">
                      <div>
                        <p className="text-gray-500">Agent:</p>
                        <p className="text-gray-300">Environment Readiness Agent</p>
                      </div>
                      <div>
                        <p className="text-gray-500">Due Date:</p>
              ...
              <div className="bg-gray-900 rounded-lg p-5 border border-gray-700">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h4 className="text-lg font-medium">Validate Mobile Regression Test Cases</h4>
                      <span className="px-2 py-1 text-xs rounded-full bg-gray-600 text-white">medium</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-gray-500 text-white">pending</span>
                    </div>
                    <p className="text-gray-400 text-sm mb-4">Review and validate generated test cases for mobile application regression testing</p>
